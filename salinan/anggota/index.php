...
<body>
    ...
    <div class="content">
        <div class="container" style="margin-top: 56px;">
            <h1 class="text-center mt-3"><b> Data Anggota</b></h1>
            <hr />
            <p class="text-center">Anggota Kartar 13</p>
                    ...
                    ?>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"><?= $orang['nama_anggota'] ?></td>
                                ...
                                <td align="center">
                                    <div class="d-flex flex-nowrap gap-2">
                                        <!-- Modal Start -->
                                        <button type="button" class="btn btn-primary bi bi-info-circle" data-bs-toggle="modal" data-bs-target="#ModalViewData<?php echo $orang['id_anggota'] ?>"></button>
                                        ...
                                        <a class='btn btn-warning' href='update.php?id=<?= $orang['id_anggota'] ?>'>
                                            <i class='bi bi-pencil-square'></i>
                                        </a>
                                        <div class="vr mx-2 bg-dark" style="width:1px;"></div>
                                        <a class='btn btn-danger' href='delete.php?id=<?= $orang['id_anggota'] ?>'>
