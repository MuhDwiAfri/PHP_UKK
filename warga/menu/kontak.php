                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <label class="bold" style="text-transform: uppercase;">Nama : <?= $kontak['nama_anggota'] ?></label>
                                    <br>
                                    <label class="bold" style=" margin-top: 4px; ">E-mail : <?= $kontak['email'] ?></label>
                                    <br>
                                    <label class="bold" style="text-transform: uppercase; margin-top: 4px; ">Telp / WA : <?= $kontak['telp_anggota'] ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
