...
<body>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 px-3">
        ...
        if (isset($_POST['submit'])) {
            ...
            $query = "SELECT * FROM kas_keluar WHERE tanggal_keluar BETWEEN '$format_tanggal_awal 00:00:00' AND '$format_tanggal_akhir 23:59:59'";
        ...
        <form method="post" action="kas_keluar.php">
            ...
            <table class="table table-striped table-hover table-bordered  table-sm" style="box-shadow: 0px 1px 6px 0.5px black;">
                ...
                <tbody>
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        jumlah LIKE '%" . @$cari . "%' 
                        '%" . @$cari . "%') AND tanggal_keluar BETWEEN '$format_tanggal_awal 00:00:00' AND '$format_tanggal_akhir 23:59:59'
