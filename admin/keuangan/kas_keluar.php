        ...
        <div class="row">
                ...
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-3 mb-1 text-muted">
                            <i class="bi bi-plus-circle text-white"> <span class="text-white">Pengguna</span></i>
                        ...
                        <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-3 mb-1 text-muted">
                            <i class="bi bi-plus-circle text-white"> <span class="text-white">Keuangan</span></i>
                            <a class="link-secondary" href="#" aria-label="Add a new report">
                            </a>
                        </h6>
                        <li class="nav-item">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                                ...
                                <tr>
                                    ...
                                    <td class="button">
                                        <div class="d-flex flex-nowrap gap-2">
                                            ...
                                            <a class='btn btn-outline-warning' href='update.php?id=<?= $orang['id_keluar'] ?>'>
                                                <i class='bi bi-pencil-square'></i>
                                            </a>
                                            <div class="vr mx-2 bg-dark" style="width:1px;"></div>
                                            <a class='btn btn-outline-danger' href='delete.php?id=<?= $orang['id_keluar'] ?>' onclick="return confirm('Apakah anda yakin ingin menghapus ini ?')">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $jumlah = $_POST['jumlah'];
                    $sql = "INSERT INTO kas_keluar (sumber,tanggal_keluar,keterangan,jumlah)
	                        VALUES ('$sumber','$tanggal_keluar','$keterangan','$jumlah')";
                    $result = mysqli_query($conn, $query);
                ...
                <div class="modal fade" id="Modal" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header bg-success">
                                <h1 class="modal-title fs-5 fw-bold text-white" id="ModalViewDataLabel">
                                    <i class="bi bi-database-fill-add"></i> Tambah Pemasukkan
                                </h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
