...
$id = $_GET['id'];
$result = mysqli_query($conn, "SELECT * FROM admin_kartar where id_admin=$id");
...
<body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Edit Data : <?= $data['nama_admin'] ?></h1>
                ...
                <form action="" method="post" enctype="multipart/form-data " action="proses_edit.php?id=$_GET['id']">
                    <h6>
                        ...
                        <input type="text" id="nama" name="nama_admin" value="<?php echo $data["nama_admin"]; ?>" class="form-control">
                        <br>
                        <label for="telp"><b>No. Telp</b></label>
                        <input type="text" id="telp" name="telp_admin" value="<?php echo $data["telp_admin"]; ?>" class="form-control">
                        <br>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sqlUPDATE = "UPDATE admin_kartar SET nama_admin='$nama', telp_admin='$telp', email='$email' WHERE id_admin=$id";
