...
<body>
    ...
    <main class="col-md-9 ms-md-auto col-lg-10 px-md-4 px-3">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h5 class="center" style="text-transform: uppercase;">Data Login</h5>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td align=""><?= $orang['name'] ?></td>
                            <td align="center"><?= $orang['username'] ?></td>
                            <td align=""><?= $orang['email'] ?></td>
                            <!-- <td align=""><?= $orang['password'] ?></td> -->
                            <td align=""><?= $orang['role'] ?></td>
                            <td class="but">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row text-start justify-content-center">
                                                        ...
                                                        <div class="col-7">
                                                            : <?php echo $orang['name'] ?><br>
                                                            : <?php echo $orang['username'] ?><br>
                                                            : <?php echo $orang['email'] ?><br>
                                                            : <?php echo $orang['role'] ?><br>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        $query2     = mysqli_query($conn, "select * from login");
