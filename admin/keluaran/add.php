...
<body>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 px-3">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Tambah Pengeluaran</h1>
        ...
        <div class="container">
            <form action="add.php" method="post" enctype="multipart/form-data">
                ...
                <br>
                <label for="tanggal_keluar"><b>Tanggal</b></label>
    ...
    if (isset($_POST['tambah'])) {
        ...
        $sqlInsert = "INSERT INTO kas_keluar ( sumber, jumlah, tanggal_keluar, keterangan)
                      VALUES ( '$sumber', '$jumlah', '$tanggal_keluar', '$keterangan' )";
